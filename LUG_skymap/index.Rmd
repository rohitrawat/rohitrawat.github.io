...
Today we discuss a subset of this app which asks for a users location and displays an image of the sky with constellations from that place.
...
We have to add handler for `getImage`
